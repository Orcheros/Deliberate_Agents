...
Follow the `development` workflow step files in order:
1. `step-01-understand.md` — Read the task, explore relevant code, plan your approach
2. `step-02-implement.md` — Write the code
3. `step-03-test.md` — Run tests, fix failures
4. `step-04-complete.md` — Commit, update status
